...
?>
            ...
            <div class="sm-series-layout shadow-xl space-y-8" data-sm-series-term-id="<?php echo esc_attr((string) $term->term_id); ?>"<?php echo SeriesStyleHelper::layoutContainerStyle($style); ?>>
